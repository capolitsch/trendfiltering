...
#' 
#' Given the choice of \eqn{k}, the hyperparameter
#' \eqn{\gamma} is used to tune the complexity (i.e. the wiggliness)
...
#' choice of \eqn{\gamma}. The selection of \eqn{\gamma}
...
#' \eqn{Q} so that \mjeqn{\mathbb{E}_Q\[\cdot\]}{ascii} is the mathematical
...
#' \mjsdeqn{\begin{align}
#' R(\gamma) &= \frac{1}{n}\sum_{i=1}^{n}\mathbb{E}_{Q}\Big[\big(f(t_i) - \widehat{f}_0(t_i;\gamma)\big)^2\;\Big|\;t_1,\dots,t_n\Big] \cr
